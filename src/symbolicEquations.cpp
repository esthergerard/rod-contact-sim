...
void symbolicEquations::generateContactPotentialPiecewiseFunctions(bool imc)
{
    ...
    else
    {
        ...
        DenseMatrix E_p2p_ipc_gradient(1, 6);
        jacobian(E_p2p_ipc_potential, nodes_p2p, E_p2p_ipc_gradient);
        DenseMatrix E_p2p_ipc_hessian(6, 6);
        jacobian(E_p2p_ipc_gradient, nodes_p2p, E_p2p_ipc_hessian);

        E_p2p_ipc_gradient_func.init(func_p2p_inputs, E_p2p_ipc_gradient.as_vec_basic(), symbolic_cse, opt_level);
        E_p2p_ipc_hessian_func.init(func_p2p_inputs, E_p2p_ipc_hessian.as_vec_basic(), symbolic_cse, opt_level);
    }
    ...
    else
    {
        ...
        DenseMatrix E_e2p_ipc_gradient(1, 9);
        jacobian(E_e2p_ipc_potential, nodes_e2p, E_e2p_ipc_gradient);
        DenseMatrix E_e2p_ipc_hessian(9, 9);
        jacobian(E_e2p_ipc_gradient, nodes_e2p, E_e2p_ipc_hessian);

        E_e2p_ipc_gradient_func.init(func_e2p_inputs, E_e2p_ipc_gradient.as_vec_basic(), symbolic_cse, opt_level);
        E_e2p_ipc_hessian_func.init(func_e2p_inputs, E_e2p_ipc_hessian.as_vec_basic(), symbolic_cse, opt_level);
    }
    ...
    else
    {
        ...
        DenseMatrix E_e2e_ipc_gradient(1, 12);
        jacobian(E_e2e_ipc_potential, nodes_e2e, E_e2e_ipc_gradient);
        DenseMatrix E_e2e_ipc_hessian(12, 12);
        jacobian(E_e2e_ipc_gradient, nodes_e2e, E_e2e_ipc_hessian);

        E_e2e_ipc_gradient_func.init(func_e2e_inputs, E_e2e_ipc_gradient.as_vec_basic(), symbolic_cse, opt_level);
        E_e2e_ipc_hessian_func.init(func_e2e_inputs, E_e2e_ipc_hessian.as_vec_basic(), symbolic_cse, opt_level);
    }
}

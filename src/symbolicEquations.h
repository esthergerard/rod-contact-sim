...
public:
    ...
    void generateContactPotentialPiecewiseFunctions(bool imc);
    ...
    LLVMDoubleVisitor E_p2p_ipc_gradient_func;
    LLVMDoubleVisitor E_p2p_ipc_hessian_func;
    LLVMDoubleVisitor E_e2p_ipc_gradient_func;
    LLVMDoubleVisitor E_e2p_ipc_hessian_func;
    LLVMDoubleVisitor E_e2e_ipc_gradient_func;
    LLVMDoubleVisitor E_e2e_ipc_hessian_func;
